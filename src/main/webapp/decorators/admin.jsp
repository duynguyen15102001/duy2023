...
<script type="text/javascript">
    ...
    function showAlertAfterAssignBuilding(callback) {
        swal({
            title: "Giao toà nhà",
            text: "Bạn đã giao toà nhà thành công",
            type: "success",
            showConfirmButton: true,
            confirmButtonText: "Xác nhận",
            confirmButtonClass: "btn btn-success",
    ...
    function showAlertAfterAssignCustomer(callback) {
        swal({
            title: "Giao khách hàng",
            text: "Bạn đã giao khách hàng thành công",
            type: "success",
            showConfirmButton: true,
            confirmButtonText: "Xác nhận",
            confirmButtonClass: "btn btn-success",
